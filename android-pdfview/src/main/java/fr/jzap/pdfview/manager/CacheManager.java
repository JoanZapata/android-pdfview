...
import fr.jzap.pdfview.impl.PagePart;
...
public class CacheManager {
	...
	public CacheManager() {
		activeCache = new PriorityQueue<PagePart>(Constants.CACHE_SIZE, new PagePartComparator());
		passiveCache = new PriorityQueue<PagePart>(Constants.CACHE_SIZE, new PagePartComparator());
	...
	public void cacheThumbnail(PagePart part){
		...
		// If cache too big, remove and recycle
		if (thumbnails.size() >= Constants.THUMBNAILS_CACHE_SIZE){
