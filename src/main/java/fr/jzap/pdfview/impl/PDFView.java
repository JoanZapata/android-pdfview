...
import fr.jzap.pdfview.IPDFView;
import fr.jzap.pdfview.async.DecodingAsyncTask;
import fr.jzap.pdfview.async.RenderingAsyncTask;
...
import fr.jzap.pdfview.manager.AnimationManager;
import fr.jzap.pdfview.manager.CacheManager;
import fr.jzap.pdfview.manager.DragPinchManager;
import fr.jzap.pdfview.manager.SpiralLoopManager;
import fr.jzap.pdfview.manager.SpiralLoopManager.SpiralLoopListener;
import fr.jzap.pdfview.util.ArrayUtils;
import fr.jzap.pdfview.util.NumberUtils;
 ...
 * 
 */
public class PDFView extends SurfaceView implements IPDFView {
	...
	public void loadPages() {
		...
		int parts = 0;
		for (int i = 0; i<=Constants.LOADED_SIZE/2 && parts<Constants.CACHE_SIZE; i++){
			parts += loadPage(index+i, Constants.CACHE_SIZE-parts);
			if (i!=0 && parts<Constants.CACHE_SIZE){
				parts += loadPage(index-i, Constants.CACHE_SIZE-parts);
			}
		}
